...
class FoundFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        databaseReference = FirebaseDatabase.getInstance().reference.child("FoundItems")
        storageReference = FirebaseStorage.getInstance().reference.child("Found_images")
    ...
    private fun openDialog() {
        val dialogView = LayoutInflater.from(requireContext()).inflate(R.layout.found_dialog, null)

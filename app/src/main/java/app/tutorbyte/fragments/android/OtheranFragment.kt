...
class OtheranFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_otheran, container, false)
        val webView = view?.findViewById<WebView>(R.id.webView)

        val url = "https://drive.google.com/file/d/1JEV5E7yzFlugjFZ8tB-NlkffCqe7oDrg/preview"
